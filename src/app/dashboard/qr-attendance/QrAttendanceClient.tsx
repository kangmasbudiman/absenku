...
import { Check, Copy, QrCode, RefreshCw, Search, Clock, User, ChevronDown, AlertCircle } from 'lucide-react'
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        {initialTokens.length === 0 ? (
          <div className="px-6 py-8 text-center">
            <p className="text-sm text-gray-400">Belum ada QR token yang dibuat hari ini</p>
          </div>
        ) : (
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50/50">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Dibuat Oleh</th>
              ...
              <tbody className="divide-y divide-gray-50">
                {initialTokens.map(t => (
                  <tr key={t.id} className="hover:bg-gray-50/50">
                    ...
                    <td className="px-4 py-3 text-gray-600">{t.generator?.[0]?.full_name || '-'}</td>
