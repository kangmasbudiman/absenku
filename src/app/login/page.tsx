...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Kalau bukan email, cari email dari username di tabel profiles
      if (!isEmail) {
        ...
        // Cari email dari auth.users via admin API
        // Karena client tidak bisa query auth.users, gunakan pendekatan RPC
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-teal-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
        <div className="flex items-center gap-2 mb-8">
          ...
          <span className="font-bold text-xl text-teal-600">AbsenKu Admin</span>
        </div>
