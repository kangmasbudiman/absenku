...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        // Try to extract actual error message from function response body
      ...
      <div className="min-h-screen bg-gradient-to-br from-teal-50 to-teal-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <div className="bg-teal-50 border border-teal-100 rounded-xl p-4 text-left space-y-3 mb-6">
            ...
            {[
              'Tim AbsenKu akan meninjau data perusahaan Anda',
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-xl overflow-hidden">
        <div className="bg-gradient-to-r from-teal-600 to-teal-500 px-8 py-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="font-bold text-lg text-white">AbsenKu</span>
          </div>
